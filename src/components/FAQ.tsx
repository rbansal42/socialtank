...
const FAQS = [
  {
    ...
    a: "SocialTank is open to all school students from classes 8-12. Teams of 2-4 members from the same school can register. There is no limit on the number of teams per school.",
  },
  {
